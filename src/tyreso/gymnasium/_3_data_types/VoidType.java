...
public class VoidType {
     ...
     */
    BooleanTypes bool = null;   //Skapa en referens (mer om detta snart) till ett objekt av typen BooleanTypes
                                //som inte pekar på något objekt alls.

    CharacterType chars = null; //Observera att alla variabeldeklarationer av referenstyper som bara deklarerats utan
